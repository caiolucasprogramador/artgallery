...
public interface IArtGallery {
    ...
    boolean adicionarObraEmExposicao(int idObra, int idExpo) throws SQLException;
    ...
    void atualizarObra(Obra obraAtualizada) throws SQLException, ObraNaoEncontradaException;
}